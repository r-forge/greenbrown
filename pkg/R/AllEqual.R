AllEqual <- structure(function(
	...
	##description<<
	## This function is used to check if all values in a vector are equal. It can be used for example to check if a time series contains only 0 or NA values and should be excluded from computations.
