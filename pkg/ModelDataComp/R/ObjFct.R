ObjFct <- structure(function(
	...
	## Objective functions
	##description<<
	## Calculate model performance measures: correlation coefficient, coefficient of determination, average error, 
	...
	groups=NULL
	### vector of groups to compute objective functions for subsets of sim/obs
...
text.ObjFct <- structure(function(
	##title<< 
	## Convert objective functions to text
	##description<<
	## Convert objective functions to text.
	...
	### which objective function metrics sshould be converted to text?
