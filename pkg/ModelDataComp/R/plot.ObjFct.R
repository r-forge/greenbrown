...
# create some data
obs <- 1:40
sim <- c(1:30 * c(rnorm(10, 1, 0.1), rnorm(10, 1, 0.3), rnorm(10, 1, 2)), 40:31)
groups <- c(rep("subset 1", 10), rep("subset 2", 10), rep("subset 3", 10), rep("subset 4", 10))
plot(sim, obs, col=rep(1:4, each=10))
